  ...
  return (
    <>
      <ul className={className ? `${className}` : "categories"}>
        ...
        {isHomePage ? <ScrollLink smooth={true} duration={500} onClick={handleTitleContact} to="contacto" offset={-110} ><li>Contacto</li></ScrollLink> : <Link to="/" onClick={() => { handleLinkClick("contacto"), onFormTitleChange("¿Necesitás comunicarte") }}><li>Contacto</li></Link>}
